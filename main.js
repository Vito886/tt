...
document.querySelector("#add").addEventListener("click", () => {
    let fac = document.querySelector("#addInputFac").value;
    let name = document.querySelector("#addInputName").value;
    let course = document.querySelector("#addInputCourse").value;
    let group = document.querySelector("#addInputGroup").value;

    let element = document.createElement("group");
    element.innerHTML = "<facultet>" + fac + "</facultet><cource>" + course + "</cource><name>" + group + "</name><students><student><name>" + name + "</name><marks><mark>2</mark><mark>2</mark><mark>2</mark><mark>2</mark></marks></student></students><subjects><subject><name>Матан</name></subject><subject><name>Физика</name></subject><subject><name>Ин.яз</name></subject><subject><name>Русский</name></subject></subjects>";
